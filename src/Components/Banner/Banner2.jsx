    ...
    <div className="py-12 sm:py-0 relative">
      <div className="container min-h-[620px] flex items-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 place-items-center">
          ...
          <div className="lg:pr-20 order-2 sm:order-1 relative">
            <div className="relative z-10 space-y-5">
              ...
              <p data-aos="fade-up" data-aos-delay="500">
                ...
                Corrupti ut expedita voluptate temporibus reprehenderit
                veritatis ex illum magni repellat! Soluta.
              </p>
            ...
            rounded-full absolute bottom-[-200px] left-[300px] blur-3xl opacity-50"
            ></div>
          </div>
